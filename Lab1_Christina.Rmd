...
```{r}
# Import data
icd10cm_codes_2020 <- read_delim("/Users/k.listila/Desktop/icd10cm_codes_2020.txt", 
                   delim = "\t", 
                   escape_double = FALSE, 
                   col_names = FALSE, 
                   trim_ws = TRUE)
...
```{r}
# Import data
inpatient_claims <- read.csv("/Users/k.listila/Desktop/DE1_0_2008_to_2010_Inpatient_Claims_Sample_1.csv")
beneficiary_summary <- read.csv("/Users/k.listila/Desktop/DE1_0_2008_Beneficiary_Summary_File_Sample_1.csv")
```
